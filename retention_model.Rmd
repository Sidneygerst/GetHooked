...
customer_subset <- all_customers %>% 
  dplyr::select(covid_end, delivery_count, necessary_grocery, age, income, id) %>%
...
#plot the model
plot(Effect(focal.predictors = c("necessary_grocery", "delivery_count"), model), main = "Effect Plot", 
